...
# example call: function packname:generic/functions/raycast_mode/ignore_all/start {"length":"100","hitEnd":"function","vfx":"function"}
## Raycast: Ignore All Start Function
# run raycast
$scoreboard players set @s generic.raycast.step $(length)
tag @s add genericRaycaster
$function packname:generic/functions/raycast_mode/ignore_all/step {"hitEnd":"$(hitEnd)","vfx":"$(vfx)"}
