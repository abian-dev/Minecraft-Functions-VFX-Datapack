...
execute rotated as @s run function packname:generic/functions/random_pos/find

# recursive call
scoreboard players remove %genFuncRandomPos.itt generic.z 1
execute if score %genFuncRandomPos.itt generic.z matches 1.. run function packname:generic/functions/random_pos/init with storage genfunc randomPos
