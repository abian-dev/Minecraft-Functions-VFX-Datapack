# example call: function packname:generic/functions/random_pos/start {"itt":"1","yaw":"180","pitch":"90","distMin":"0","distMax":"10","atPos":"function"}
...
execute as @e[type=marker,limit=1,sort=nearest,tag=genFunc.randomPos] at @s run function packname:generic/functions/random_pos/init with storage genfunc randomPos
