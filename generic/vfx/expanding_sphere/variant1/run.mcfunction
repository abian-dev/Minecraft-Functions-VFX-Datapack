...
# draw
tp @s ~ ~ ~ 0 -90
execute if score %vfxExpandingSphere.iterations generic.z < %vfxExpandingSphere.limit generic.constant at @s run function packname:generic/vfx/expanding_sphere/variant1/draw_sphere with storage minecraft:vfx expandingSphere
execute if score %vfxExpandingSphere.iterations generic.z >= %vfxExpandingSphere.limit generic.constant run function packname:generic/vfx/expanding_sphere/variant1/end