...
# draw
tp @s ~ ~ ~ 0 -90
$execute if score %vfxExpandingSphere.$(id).iterations generic.z < %vfxExpandingSphere.$(id).limit generic.constant at @s run function packname:generic/vfx/expanding_sphere/variant1/draw_sphere with storage minecraft:vfx expandingSphere.$(id)
$execute if score %vfxExpandingSphere.$(id).iterations generic.z >= %vfxExpandingSphere.$(id).limit generic.constant run function packname:generic/vfx/expanding_sphere/variant1/end with storage minecraft:vfx expandingSphere.$(id)