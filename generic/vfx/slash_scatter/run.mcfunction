...
$execute at @s run function packname:generic/vfx/slash_scatter/pos {"inaccuracy":"$(inaccuracy)"}
...
$execute at @s run function packname:generic/vfx/slash_scatter/slash_fwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}
$scoreboard players set @s generic.raycast.step $(slashLength)
$execute at @s run function packname:generic/vfx/slash_scatter/slash_bwd {"inaccuracy":"$(inaccuracy)","vfx":"$(vfx)"}

# recursive call
scoreboard players remove @s generic.dz 1
$execute if score @s generic.dz matches 0.. run function packname:generic/vfx/slash_scatter/run {"inaccuracy":"$(inaccuracy)","slashLength":"$(slashLength)","slashScatter":"$(slashScatter)","vfx":"$(vfx)"}
execute if score @s generic.dz matches ..-1 run function packname:generic/vfx/slash_scatter/end