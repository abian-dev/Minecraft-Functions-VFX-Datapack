# example call: function packname:generic/vfx/rotating_vertical/general/play {"speed":"200","duration":"20","vfx":"function"}
...
# execute
function packname:generic/vfx/rotating_vertical/general/execute with storage minecraft:vfx curr.rotatingVertical