...
execute if score %vfxSlashEncircle.dist generic.z < %vfxSlashEncircle.restr generic.constant run function packname:generic/vfx/slash_encircle/get with storage minecraft:vfx slashEncircle