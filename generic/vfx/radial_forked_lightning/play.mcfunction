# example call: function packname:generic/vfx/radial_forked_lightning/play {"inaccuracy":"100","rootsMin":"3","rootsMax":"5","branchesMin":"3","branchesMax":"5","branchLengthMin":"5","branchLengthMax":"10","particle":"flame"}
...
execute as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=vfxRadialForkedLightning] at @s run function packname:generic/vfx/radial_forked_lightning/start with storage minecraft:vfx radialForkedLightning
function packname:generic/vfx/radial_forked_lightning/end