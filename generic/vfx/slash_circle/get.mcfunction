...
# values with x,y,z
$function packname:generic/vfx/slash_circle/calc_init {"objective":"generic.x","id":"$(id)"}
$function packname:generic/vfx/slash_circle/calc_init {"objective":"generic.y","id":"$(id)"}
$function packname:generic/vfx/slash_circle/calc_init {"objective":"generic.z","id":"$(id)"}
...
$function packname:generic/vfx/slash_circle/newton_raphson with storage minecraft:vfx slashCircle.$(id)
$function packname:generic/vfx/slash_circle/newton_raphson with storage minecraft:vfx slashCircle.$(id)
$function packname:generic/vfx/slash_circle/newton_raphson with storage minecraft:vfx slashCircle.$(id)
$function packname:generic/vfx/slash_circle/newton_raphson with storage minecraft:vfx slashCircle.$(id)
$function packname:generic/vfx/slash_circle/newton_raphson with storage minecraft:vfx slashCircle.$(id)
