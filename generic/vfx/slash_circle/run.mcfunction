## Runs Circle Slash
# draw arc
$function packname:generic/vfx/slash_circle/arc with storage minecraft:vfx slashCircle.$(id)
$execute positioned as @s run function packname:generic/vfx/slash_circle/draw with storage minecraft:vfx slashCircle.$(id)
...
$execute if score %vfxSlashCircle.$(id).arcSteps generic.dz >= %vfxSlashCircle.$(id).maxSteps generic.constant run return run function packname:generic/vfx/slash_circle/end with storage minecraft:vfx slashCircle.$(id)
$execute if score %vfxSlashCircle.$(id).diameterSteps generic.dz >= %vfxSlashCircle.$(id).accuracy generic.constant run return run function packname:generic/vfx/slash_circle/flip with storage minecraft:vfx slashCircle.$(id)

# recursive call for draw speed
$scoreboard players add %vfxSlashCircle.$(id).runItt generic.dz 1
$execute unless score %vfxSlashCircle.$(id).runItt generic.dz > %vfxSlashCircle.$(id).speed generic.dz run function packname:generic/vfx/slash_circle/run with storage minecraft:vfx slashCircle.$(id)
