## Runs Circle Slash
# draw arc
function packname:generic/vfx/slash_circle/arc
execute positioned as @s run function packname:generic/vfx/slash_circle/draw with storage minecraft:vfx slashCircle
...
execute if score %vfxSlashCircle.arcSteps generic.dz >= %vfxSlashCircle.maxSteps generic.constant run return run function packname:generic/vfx/slash_circle/end
execute if score %vfxSlashCircle.diameterSteps generic.dz >= %vfxSlashCircle.accuracy generic.constant run return run function packname:generic/vfx/slash_circle/flip
