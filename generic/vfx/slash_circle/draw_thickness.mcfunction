...
$scoreboard players operation %vfxSlashCircle.$(id).thicknessOffset generic.dz += %vfxSlashCircle.$(id).dist generic.constant
...
$execute unless score %vfxSlashCircle.$(id).thicknessOffset generic.dz >= %vfxSlashCircle.$(id).thicknessAtStep generic.dz positioned as @s run function packname:generic/vfx/slash_circle/draw_thickness with storage minecraft:vfx slashCircle.$(id)