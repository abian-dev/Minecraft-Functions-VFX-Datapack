...
$function packname:generic/vfx/domain/newton_raphson with storage minecraft:vfx domain.$(id)
$function packname:generic/vfx/domain/newton_raphson with storage minecraft:vfx domain.$(id)
$function packname:generic/vfx/domain/newton_raphson with storage minecraft:vfx domain.$(id)
$function packname:generic/vfx/domain/newton_raphson with storage minecraft:vfx domain.$(id)
$function packname:generic/vfx/domain/newton_raphson with storage minecraft:vfx domain.$(id)
...
# draw circle
$execute at @s run function packname:generic/vfx/domain/draw_semicircle with storage minecraft:vfx domain.$(id)
...
$execute at @s rotated ~ 0 positioned ^ ^ ^$(circleRadius) facing entity @s feet run function packname:generic/vfx/domain/draw_floor with storage minecraft:vfx domain.$(id)

# step forward
$execute rotated ~-90 0 run tp @s ^ ^ ^$(radiusStep)
$scoreboard players remove %vfxDomain.$(id).speed generic.z 1
$execute if score %vfxDomain.$(id).speed generic.z matches 0.. run execute at @s[tag=!vfxDomainFullSphere] run function packname:generic/vfx/domain/draw_sphere with storage minecraft:vfx domain.$(id)