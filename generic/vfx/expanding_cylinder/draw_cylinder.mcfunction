...
$function packname:generic/vfx/expanding_cylinder/draw_circle with storage minecraft:vfx expandingCylinder.$(id)
...
$execute unless score %vfxExpandingCylinder.$(id).height generic.z >= %vfxExpandingCylinder.$(id).height generic.constant at @s run function packname:generic/vfx/expanding_cylinder/draw_cylinder with storage minecraft:vfx expandingCylinder.$(id)