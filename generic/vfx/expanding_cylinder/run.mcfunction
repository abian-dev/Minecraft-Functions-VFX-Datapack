...
# draw
tp @s ~ ~ ~ 0 0
execute if score %vfxExpandingCylinder.iterations generic.z < %vfxExpandingCylinder.limit generic.constant at @s run function packname:generic/vfx/expanding_cylinder/draw_cylinder with storage minecraft:vfx expandingCylinder
execute if score %vfxExpandingCylinder.iterations generic.z >= %vfxExpandingCylinder.limit generic.constant run function packname:generic/vfx/expanding_cylinder/end