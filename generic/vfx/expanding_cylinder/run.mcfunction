...
# draw
tp @s ~ ~ ~ 0 0
$execute if score %vfxExpandingCylinder.$(id).iterations generic.z < %vfxExpandingCylinder.$(id).limit generic.constant at @s run function packname:generic/vfx/expanding_cylinder/draw_cylinder with storage minecraft:vfx expandingCylinder.$(id)
$execute if score %vfxExpandingCylinder.$(id).iterations generic.z >= %vfxExpandingCylinder.$(id).limit generic.constant run function packname:generic/vfx/expanding_cylinder/end with storage minecraft:vfx expandingCylinder.$(id)