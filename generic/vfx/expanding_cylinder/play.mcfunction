# example call: function packname:generic/vfx/expanding_cylinder/play {"accuracy":"200","speed":"200","limit":"5","height":"2000","particle":"flame"}
...
# execute
function packname:generic/vfx/expanding_cylinder/execute with storage minecraft:vfx curr.expandingCylinder