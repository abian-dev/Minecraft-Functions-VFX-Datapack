...
# values with x,y,z
function packname:generic/vfx/slash_crescent/calc_init {"objective":"generic.x"}
function packname:generic/vfx/slash_crescent/calc_init {"objective":"generic.y"}
function packname:generic/vfx/slash_crescent/calc_init {"objective":"generic.z"}
