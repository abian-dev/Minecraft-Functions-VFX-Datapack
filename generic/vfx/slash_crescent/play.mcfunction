# example call: function packname:generic/vfx/slash_crescent/play {"concavity":"400","thickness":"5","accuracy":"50","yaw":"90","pitch":"0","distance":"5","particle":"flame"}
...
execute as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=vfxSlashCrescent] at @s run function packname:generic/vfx/slash_crescent/get with storage minecraft:vfx slashCrescent
function packname:generic/vfx/slash_crescent/end