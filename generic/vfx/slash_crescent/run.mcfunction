## Runs Crescent Slash
# draw parabola
function packname:generic/vfx/slash_crescent/parabola
execute positioned as @s run function packname:generic/vfx/slash_crescent/draw with storage minecraft:vfx slashCrescent
...
execute if score %vfxSlashCrescent.thickness generic.dz matches 1.. if score %vfxSlashCrescent.runItt generic.dz > %vfxSlashCrescent.accuracy generic.constant run function packname:generic/vfx/slash_crescent/thickness
execute unless score %vfxSlashCrescent.runItt generic.dz > %vfxSlashCrescent.accuracy generic.constant run function packname:generic/vfx/slash_crescent/run